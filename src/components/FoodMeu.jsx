    ...
    return (
        <div className="my-1">
            ...
            <div className="flex flex-col md:flex-row gap-4">
                ...
                <div className="card w-96 glass">
                    <figure className="h-52"><img src="https://cdn.loveandlemons.com/wp-content/uploads/2019/07/salad.jpg" alt="car!" /></figure>
                    <div className="card-body">
                ...
                <div className="card w-96 glass">
                    <figure  className="h-52"><img src="https://cookingchew.com/wp-content/uploads/2022/01/Fancy-Desserts_1-min.jpg" alt="car!" /></figure>
                    <div className="card-body">
