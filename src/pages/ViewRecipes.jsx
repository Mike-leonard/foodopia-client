    ...
    return (
        <div className="view-recipes-container">
            <div className="grid justify-items-end">
                <div className="card w-96 md:w-96 lg:w-96 glass mt-3 justify-self-center md:justify-self-center lg:justify-self-end lg:right-10">
            ...
            <RecipeDetails chef={chef}></RecipeDetails>
        </div>
    );
};
